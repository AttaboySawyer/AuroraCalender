file:///C:/Users/yashb/Documents/AuroraCalender/webview-ui/src/main/scala/types/Configs.scala
### dotty.tools.dotc.core.TypeError$$anon$1: bad parameter reference T at typer
the parameter is type T in class ColumnConfig but the prefix <noprefix>
...
action parameters:
offset: 1748
uri: file:///C:/Users/yashb/Documents/AuroraCalender/webview-ui/src/main/scala/types/Configs.scala
text:
```scala
package types
        ...
        cellType match {
            ...
            case UneditableDivType =>
                UneditableDiv(
                  ...
                  config.client,
                  fieldName,
                  config.r@@owIdentifier(item)
                ).render()
            case CalenderDayDivType =>
                CalenderDayDiv(
                  item.asInstanceOf[Day].shifts,
                  config.client,
                  fieldName,
                  config.rowIdentifier(item)
                ).render()
