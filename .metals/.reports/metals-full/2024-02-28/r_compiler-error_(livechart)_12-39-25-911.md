file:///C:/Users/yashb/Documents/AuroraCalender/webview-ui/src/main/scala/components/cells/CalenderDayDiv.scala
...
case class CalenderDayDiv(
    ...
    def rednerAddButton(show: Signal[Boolean]): Signal[HtmlElement] = {
        show.map {
            case true =>
                div(
                  ...
                  "➕",
                  onClick --> (e => {
                      model.dataModelVar.update(weeks => weeks.m@@)
                  })
                )
            case false => div()
        }
        ...
        td(
          div(
            ...
            div(
              ...
              day.day,
              child <-- rednerAddButton(showAddButton.signal)
            ),
            renderShifts()
          )
        )
