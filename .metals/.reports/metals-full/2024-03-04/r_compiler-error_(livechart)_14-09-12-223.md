                    ...
                    client.copiedContent.signal
                        ...
                        case Some(value) => {
                            ...
                            client.dataModelVar.update(weeks => {
                                weeks
                                    .m@@(week =>
                                        week.getDayByNumber(day.number)
                                    )
                                    .head
                                //     shifts.map(week => {
                                //         true match {
