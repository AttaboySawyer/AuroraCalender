...
parent      =  extends HTMLConverter[UneditableDiv, Patient] {
  def tableCellToHTML(item: Patient): Element = null
} # -1,
parent span = <1298..1419>,
child       = def tableCellToHTML(item: Patient): Element = null # -1,
child span  = [1350..1354..1428]
