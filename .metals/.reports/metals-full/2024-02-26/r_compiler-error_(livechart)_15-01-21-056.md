...
parent      =  extends CellElementHTML[FlagIcon, Patient] {
  def getCellAsHTML(item: Patient): Element = null
} # -1,
parent span = <647..739>,
child       = def getCellAsHTML(item: Patient): Element = null # -1,
child span  = [696..700..1153]
...
object CellElementHTML:
    given CellElementHTML[FlagI@@con, Patient] with
        def getCellAsHTML(item: Patient): Element = 
// {
