file:///C:/Users/yashb/Documents/AuroraCalender/webview-ui/src/main/scala/components/cells/Modal.scala
...
case class Modal(
    ...
    def render() = {
        div(
          idAttr := "myModal",
          className := "modal",
          dataAttr("dayNumber") := "undefined",
          dataAttr("dayName") := "undefined",
          dataAttr("month") := "undefined",
          renderModalContent()
        )
    }
...
modalOption m@@
        div(
          ...
          h2(
            color := "black"
            // "Add Shift to " + modal.dataset("dayName") + ", " + modal.dataset(
            //   "month"
            // ) + " " + modal.dataset("dayNumber") + ", 2024"
          )
        )
    }
}
